...
def main():
    ...
    try:
        ...
        print('   query_sms(projection="address:body:date", where="read=0", sort="date DESC")')
        print()
        print("2. Get messages from specific contact:")
        print('   query_sms(where="address=\'+1234567890\'", sort="date DESC")')
        print()
        print("3. Get sent messages:")
        print('   query_sms(projection="address:body:date", where="type=2")')
        print()
        print("4. Check ADB connection:")
        print('   check_adb_connection()')
        print()
        print("5. Get unread messages (helper):")
